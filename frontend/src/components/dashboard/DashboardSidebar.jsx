    ...
    <ul className="space-y-2">
      {menuItems.map((item, i) => (
        <li key={i}>
          <Link
            to={item.to}
            className="block px-4 py-2 rounded-md border border-[#b87333] bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-gray-100 font-medium hover:bg-blue-600 hover:text-white hover:translate-x-1 hover:shadow-md transition-all duration-200"
          >
            {item.label}
          </Link>
        </li>
